...
3. Treat fresh revision, time, scene, player state, player-visible knowledge, compact cast/read hints, controlled formations, opportunities, runtime limits, semantic-action contract, and mechanic-family index as the live contract. The mechanic index never defines what Wei or an NPC is allowed to attempt in ordinary fiction.
