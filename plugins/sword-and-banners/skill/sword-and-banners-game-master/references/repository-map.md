...
`runtime/sword_runtime/scene_sessions.py` — authority:false live scene sessions, generic response-bearing conversational-thread lifecycle support, bounded recent attributed-speech head, and lossless period shards. It never owns physical presence or mechanical consequences.
