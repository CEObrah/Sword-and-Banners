...
In multi-attacker personal combat, narrate the shared body state rather than presenting a chain of independent duels. When the trace establishes defensive saturation or displacement, make the cause concrete: Wei's weight is still committed from the first dodge, his blade remains outside the opposite attack line after a parry, his shield is turned toward the threat it just intercepted, a grapple occupies one or both arms, a fall has not yet reached ground contact, or an obstacle/body blocks the intended lane. Never narrate a second pristine defense when the resolver says its reaction, weapon, shield, feet, posture, or position remain committed.
