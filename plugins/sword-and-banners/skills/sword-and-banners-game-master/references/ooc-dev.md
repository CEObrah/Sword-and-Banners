...
A test that did not run is neither passing nor failing. CI blocked by billing, quota, runner, auth, or dependency infrastructure is unrun verification, not source evidence.
