...
For this campaign, render `formation_tang_wei_house_guard` as **House Guard** in player-facing narration and choices. The exact formation ref, owner record, command authority, manpower, and canonical stored name remain untouched unless a separate lawful in-world rename is committed.
