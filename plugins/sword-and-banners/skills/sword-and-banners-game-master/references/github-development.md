...
Use the GitHub connector for repository inspection, commit archaeology, small coherent patches, branch/PR review, CI status, and normal targeted fixes.
...
7. Use CI/status only when it actually ran.
