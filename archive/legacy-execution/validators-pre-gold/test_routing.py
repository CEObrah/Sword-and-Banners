...
rr=rj('game/data/runtime/rule-router.json')
...
for rel in ('game/data/runtime/template-index.json','game/data/runtime/system-contract-index.json','game/data/runtime/narration-router.json'):
    if not (R/rel).exists():err(f'router_support_missing:{rel}')
sc=rj('game/data/runtime/system-contract-index.json')
...
texts=[]
for rel in ('RUNTIME.md','VOICE.md','REPOSITORY_MAP.md','PLAYER_INTERFACE.md','game/data/runtime/repository-map.json','game/data/runtime/rule-router.json'):
