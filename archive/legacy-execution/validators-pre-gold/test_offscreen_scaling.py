...
cat=rj("game/data/people/latent-identities.json")
...
if "materialize" not in (R/"game/rules/siege.md").read_text(encoding="utf-8").lower(): fail("siege_materialization_rule")
cov=rj("game/data/runtime/coverage-requirements.json")
