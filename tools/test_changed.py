...
RELEASE_HARNESS_TESTS = {"tests/runtime/test_release_suite_harness_policy.py"}
MERCENARY_TESTS = {
...
def select(paths: list[str]) -> list[str]:
    ...
    for raw in paths:
        ...
        if path in {"runtime/sword_runtime/bootstrap.py", "runtime/sword_runtime/deployment_attestation.py", "railway.toml"}:
        ...
        if path == "tools/run_release_suite.py":
