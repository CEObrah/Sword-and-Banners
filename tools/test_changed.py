...
GEOGRAPHY_TESTS = {"tests/runtime/test_world_geography_overhaul.py"}
...
def select(paths: list[str]) -> list[str]:
    ...
    for raw in paths:
        ...
        if (
            ...
            or path == "state/contract/tang-contracted-defense.json"
        ...
        if (
            ...
            or path.startswith("state/contract/tang-contracted-defense.json")
        ...
        if (
            ...
            or path.startswith("game/data/mil/standing-force-capability-baselines.json")
