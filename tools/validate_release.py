...
# Clean House Tang / Sword Manor rebaseline invariants.
house_force=j("state/forces/house-tang.json")
check("house_tang_30000_fighting", house_force.get("headcount")==30000 and house_force.get("authorized_by_role")=={"house_guard":18000,"guardian_cavalry":8000,"tang_champion":4000})
sword_force=j("state/forces/sword-manor.json")
check("sword_manor_30000_four_tier", sword_force.get("headcount")==30000 and sword_force.get("authorized_by_role")=={"trainee":20000,"junior_disciple":5000,"general_disciple":3500,"senior_disciple":1500})
check("wei_house_guard_3000_present", j("state/formations/tang-wei-house-guard-first.json").get("personnel")==3000)
contract=j("state/contract/tang-contracted-defense.json")
check("house_tang_contracted_defense_75000", contract.get("anonymous_total")==75000 and contract.get("combined_total")==75002)
