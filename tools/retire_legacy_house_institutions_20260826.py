...
p = 'plugins/sword-and-banners/skills/sword-and-banners-game-master/references/repository-map.md'; s = read(p)
...
write(p, s)
p = 'plugins/sword-and-banners/skills/sword-and-banners-game-master/references/player-interface.md'; s = read(p)
