...
def main() -> None:
    ...
    for ref, loc in sorted(locs.items()):
        ...
        site.update({
            ...
            "parent_site_ref": str(loc.get("parent_ref")) if str(loc.get("parent_ref", "")) in sites or str(loc.get("parent_ref", "")) in {"loc_tang_manor", "loc_tang_inner_walls"} else None,
