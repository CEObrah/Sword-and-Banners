...
`game/data/mechanics/siege.json` is the sole numerical authority for artillery crews, engineering factors, access, cycle time, range, scatter, penetration/impact, structure protection, integrity loss, stone-drop and firepot resolution. `game/data/mechanics/combat.json`, `game/data/mechanics/injury.json`, and the item catalog resolve people, weapons, animals and wounds.
...
- civilian/garrison grain endurance, water and disease;
...
Scatter uses the registered SHA-256 deterministic method in `game/data/mechanics/siege.json`. Reloading, reopening the chat, or disliking a result cannot reroll the same release.

## Bed crossbows

Bed crossbow crew, cycle, range, dispersion and penetration come from `game/data/mechanics/siege.json` and the registered item/ammunition profiles.
...
Structure protection and integrity are calculated from actual material resistance, thickness, condition, angle and impact. Integrity state follows `game/data/mechanics/siege.json`.
...
Outer contracted companies perform the duties saved in their assignments. House Guards, Guardian Cavalry and Inner Walls use their saved defensive/relief roles. This doctrine changes deployment, not physical invulnerability.
