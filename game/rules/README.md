...
The Gold audit fails if a rule file is missing from the parity map, if a `live`/`mixed` entry has no executable hook, or if a listed command/hook/host does not exist in the production runtime.
