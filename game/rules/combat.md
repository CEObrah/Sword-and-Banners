...
Exceptional individuals remain bound by the same body, timing, fatigue, contact, injury, weapon, and lane rules. Heroic tempo and minimum action interval are registered in `game/data/mechanics/combat.json`.
