...
Routine gate inspection, fire response, stable care, medical triage, warehouse rotation, ordinary patrols, scheduled instruction, and administrative processing may continue only inside saved delegated authority or the standing orders of the exact formation, command group, institution, or process that owns the work. Staff must escalate altered contracts, exceptional cargo, identity disputes, restricted equipment, major spending, appointments, deployment, hostile contact, prisoner disposition, family commitments, and political or military alignment.
