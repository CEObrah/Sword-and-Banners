...
Routine intermarket commerce remains aggregate. Market stock, private-economy commodity ownership, merchant-house capital, route condition, diplomacy, scarcity, and local security determine lawful trade and restocking. No separate merchant-convoy gameplay owner is created for routine commerce.

Player-relevant military transport uses the existing exact formation, army-train, depot, route, crossing, and logistics authorities rather than a parallel merchant-cargo subsystem.
