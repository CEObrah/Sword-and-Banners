...
Use `game/data/mechanics/support.json`. Engineering, baggage handling, signals, casualty collection, firefighting and similar military support work are temporary duties assigned from existing formation manpower. Their effectiveness comes from responsible commander/officer skill plus physical tools, stores, carts, facilities, geography and time. Scouts remain a fighting reconnaissance role. Civilian camp followers and dependents remain noncombat populations.
