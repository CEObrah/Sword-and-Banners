...
The generic scheme engine is executable for bribery, blackmail, forgery, defection, sabotage, gate opening, assassination, kidnapping, theft, misinformation, discrediting, prisoner escape, and revolt. A scheme owns no people and no implied access: the sponsor assigns existing agents, reserves exact silver, cites exact target/access/tool refs, and advances separate progress/exposure tracks through bounded work. Terminal effects are limited to consequences supported by existing physical/custody/information/political systems; completing an assassination, kidnapping, defection, or revolt scheme never bypasses the required causal action.

Court cases, evidence admission, evidentiary assessment, sovereign judgment, appeal/remand, office removal, fines/restitution, detention/release, arrest warrants, and execution of an already-held named prisoner are executable. Judgment remains distinct from objective evidence, and enforcement cannot teleport an accused person into custody or create money/property that is not represented.
