...
`data/loadouts.json` controls contents. `data/items.json` controls physical patterns. Structured mechanics registries control numerical effects. This file owns issue, custody, fit, production, and institutional-equipment semantics only.
