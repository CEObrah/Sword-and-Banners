...
class MilitaryCareerLoyaltyMixin:
    ...
    def _career_network(self) -> dict[str, Any]:
        ...
        if raw is None:
            return {
                "schema": "sword-military-career-network.v1",
                "authority": False,
        ...
        if not isinstance(raw, Mapping) or raw.get("schema") != "sword-military-career-network.v1":
    ...
    def _petition_index(self) -> dict[str, Any]:
        ...
        if raw is None:
            return {
                "schema": "sword-military-career-petition-index.v1",
                "authority": False,
                "pending_by_state": {},
                "resolved_count": 0,
            }
        if not isinstance(raw, Mapping) or raw.get("schema") != "sword-military-career-petition-index.v1":
    ...
    def _ensure_military_career_routes(self) -> None:
        ...
        for host_id, host in sorted(hosts.items()):
            ...
            if isinstance(route_state, Mapping) and int(route_state.get("version", 0)) >= _ROUTE_VERSION:
                continue
    ...
    def _personal_loyalty(self, person: dict[str, Any], state_ref: str) -> dict[str, Any]:
        ...
        if not isinstance(raw, dict) or raw.get("schema") != "sword-named-military-loyalty.v1":
            raw = {
    ...
    def _formation_loyalty(self, formation: dict[str, Any], at: str) -> dict[str, Any]:
        ...
        if not isinstance(raw, dict) or raw.get("schema") != "sword-formation-loyalty.v1":
            raw = {
                "schema": "sword-formation-loyalty.v1",
    ...
    def _create_petition(
        ...
        *,
        ...
        petition = {
            "schema": "sword-military-career-petition.v1",
