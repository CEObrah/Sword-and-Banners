...
class ProductionCampaignPlanner(
    ...
    def _activity_route_reconcile_required(self, runtime: Mapping[str, Any], at: str) -> bool:
        ...
        to catch legacy/out-of-band routing drift while monthly activity settlement
    ...
    def _reconcile_all_scheduler_domains(self, at: str) -> dict[str, Any]:
        ...
        if self.read_optional("state/politics/schemes/index.json"):
            self._scheme_ensure_host()
        ...
        player.setdefault("training_history", []).append(
            {
                ...
                "hours": verified, "requested_hours": hours, "program_ref": program_ref,
                "drill_ref": drill_ref, "development": development,
            }
        )
