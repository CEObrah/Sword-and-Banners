...
def queue_upward_report(
    ...
    rows.append(report)
    cycle["upward_reports"] = retain_upward_reports(rows)
...
def retain_upward_reports(rows: Any, *, recent_delivered: int = 48) -> list[dict[str, Any]]:
    """Keep every unresolved physical report plus bounded delivered history."""
