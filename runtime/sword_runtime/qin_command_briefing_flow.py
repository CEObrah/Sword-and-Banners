...
def sync_qin_command_briefings(planner: Any, runtime: dict[str, Any]) -> None:
    ...
    for attempt in reversed(attempts):
        ...
        if not origin_location or not bureau_location:
            raise ValueError("Qin command briefing request lacks physical communication endpoints")
        ...
        hosts[host_id] = {
            ...
            "communication_rule": "dispatch is not receipt; request and sealed reply travel through physical geography",
