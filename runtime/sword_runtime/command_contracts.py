...
COMMAND_PAYLOAD_KEYS: dict[str, frozenset[str]] = {
    ...
    "command_group_action": frozenset({"action", "command_group_ref", "display_name", "commander_ref", "parent_ref", "person_ref", "formation_ref", "role", "deputy_ref", "successor_refs", "order", "communication_ref", "location_ref"}),
