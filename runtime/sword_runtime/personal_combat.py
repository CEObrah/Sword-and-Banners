...
class PersonalCombatMixin:
    ...
    def _personal_controls(self, person: Mapping[str, Any], eq: Mapping[str, Any], environment_effects: Mapping[str, Any]) -> dict[str, float]:
        ...
        parry = 0.48 * weapon_skill + 0.20 * coord + 0.14 * awareness + 0.10 * agility + 0.08 * composure + handling_adj - impairment
        dodge = 0.36 * agility + 0.22 * awareness + 0.18 * athletics + 0.14 * coord + 0.10 * composure - impairment
        block = 0.42 * shield + 0.18 * coord + 0.15 * strength + 0.15 * awareness + 0.10 * composure - impairment
