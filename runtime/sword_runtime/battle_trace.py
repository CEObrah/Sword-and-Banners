...
from sword_runtime.terrain import terrain_has
    ...
    *,
    ...
    contract = {
        ...
        "gm_private_director_use": [
            "full causal trace",
            "resolved formation score breakdowns",
            "named-person intervention details",
            "actual casualty, equipment, ammunition, cohesion and terrain consequences",
        ],
        "player_output_must_not_state_without_lawful_observation": [
            ...
            "enemy commander statistics, private plans, or knowledge not lawfully visible to Tang Wei",
        ],
        "do_not_reveal": [
            "causal seed or deterministic variance",
            "hidden numeric score breakdowns as narration",
        ...
        "director_rule": "The GM may use the complete resolved battle result privately to understand why the battle developed as it did. Hidden causal truth improves choreography and NPC coherence but does not become Tang Wei's knowledge until observable or lawfully reported.",
