...
class OperationalBattlefieldMixin:
    ...
    def _battlefield_report_latency(self, battlefield: Mapping[str, Any], sector_ref: str, side_ref: str) -> int:
        ...
        return max(0, base + max(0, distance) * per_unit)
    ...
    def _battlefield_apply_battle_result(self, *, operation_ref: str, battlefield_ref: str, sector_ref: str, attacker_refs: Sequence[str], defender_refs: Sequence[str], winner: str, event_id: str, at: CampaignTime) -> None:
        ...
        operation.setdefault("battlefield_history", []).append({"at": str(at), "changes": [{"kind": "exact_battle_reconciled", "battlefield_ref": battlefield_ref, "sector_ref": sector_ref, "event_id": event_id, "winner_side_ref": winner_side, "loser_side_ref": loser_side}]})
        self.put(path, operation)
