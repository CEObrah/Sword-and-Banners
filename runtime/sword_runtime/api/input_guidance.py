...
COMMAND_INPUT_GUIDANCE: Mapping[str, Mapping[str, Any]] = {
    ...
    "house_action": {
        "action": {"allowed_values": ["assign_duty", "set_policy", "grant_nobility", "proclaim_territorial_authority", "accept_bastion_applicants"], "default": "assign_duty"},
    ...
    "army_train_action": {
        ...
        "action": {"allowed_values": ["damage_transport", "destroy_transport", "repair_transport", "delay_baggage", "clear_delay", "set_relief_corridor", "break_camp"]},
        "quantity": {"type": "integer", "minimum": 1, "maximum": 100000, "applies_to": ["damage_transport", "destroy_transport", "repair_transport"]},
        ...
        "rule": "transport actions mutate already-assigned aggregate capacity/condition/camp state; they never create supply, transport capacity, drivers, guards, or personnel",
    },
