...
COMMAND_INPUT_GUIDANCE: Mapping[str, Mapping[str, Any]] = {
    ...
    "health_injury": {
        "severity": {"allowed_values": ["minor", "moderate", "severe", "critical"], "default": "minor"},
    },
    "health_recovery": {
    ...
    "enlisted_service_pay": {
        "amount_silver": {"type": "integer", "minimum": 1, "maximum": 1000000000, "default": 7},
    },
    "resupply": {
    ...
    "formation_reconstitute": {
        "target_personnel": {"type": "integer", "minimum": 1, "maximum": 1000000},
        "equipment_units": {"type": "integer", "minimum": 0, "maximum": 1000000},
        "formation_ref": {"rule": "use an exact controlled formation ref"},
    },
    "formation_split": {
    ...
    "formation_training_set": {
        "training_ref": {"rule": "must be an exact registered training-profile ref; do not guess hidden training IDs"},
    },
    "personal_combat": {
    ...
    "operation_transition": {
        "status": {"allowed_values": ["planned", "mobilizing", "active", "engaged", "occupied", "completed", "cancelled"]},
    },
    "information_create": {
        "claim": {"type": "string", "maximum_length": 4000},
        "knowers": {"type": "array", "minimum_items": 1, "maximum_items": 128, "rule": "use exact person refs"},
    },
    "state_action": {
    ...
    "siege_start": {
        "attacker_formation_refs": {"type": "array", "minimum_items": 1, "maximum_items": 128, "rule": "use exact controlled formation refs"},
    },
    "siege_action": {
    ...
    "scene_consequence": {
        "summary": {"type": "string", "maximum_length": 4000},
    },
}
