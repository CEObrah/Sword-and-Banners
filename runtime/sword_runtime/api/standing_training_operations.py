    ...
    def play_context(self):
        ...
        command_types["standing_training_settle"] = {
            ...
            "input_guidance": {
                ...
                "focus_rule": (
                    "caller-supplied focuses are forbidden. A saved formation regimen delegates adaptive training: "
                    "the runtime re-ranks weak useful, role/loadout, promotion-relevant and command/logistics needs "
                    "for conserved troop cohorts and internal represented 1,000/500 officers."
                ),
                "officer_chain_rule": (
