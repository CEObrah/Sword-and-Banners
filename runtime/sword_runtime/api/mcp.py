...
def create_mcp_server(
    ...
    *,
    ...
    @server.tool(
        ...
        description="Required first live-play call. Returns bounded player-visible state, revision, scene, permitted IDs, a scene-first GM writer workspace with active-scene direction, semantic-action guidance, and compact mechanic families. Mechanic families are not an action menu.",
