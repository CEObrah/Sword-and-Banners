    ...
    *,
    ...
    server = MCPServer(
        ...
        instructions=(
            ...
            "Select an intent family from the compact command index, call get_command_family for that one family, then call get_command_contract for the selected operation before preview. Unsupported intent fails closed."
        ),
        version="0.3.0",
    ...
    @server.tool(
        ...
        description="Required first live-play call. Returns bounded player-visible state, revision, scene, permitted IDs, and compact command intent families.",
