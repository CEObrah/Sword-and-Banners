...
def create_mcp_server(
    ...
    *,
    ...
    @server.tool(
        ...
        description="Required first live-play call. Returns bounded player-visible state, revision, scene, permitted IDs, semantic-action guidance, and compact mechanic families. Mechanic families are not an action menu.",
