...
persistent mixed-role formation or an intact nested army command.  Nested army
contents never count as additional parent direct slots and are never flattened
