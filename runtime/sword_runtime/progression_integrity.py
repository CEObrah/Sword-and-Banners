"""Current progression consistency checks for named people.

Saved attributes, skills, EDU banks and verified counters are authoritative.
This module checks live cycle settlement only; it carries no migration or repair
provenance.
"""
...
__all__ = ["exact_activity_shortfall"]
