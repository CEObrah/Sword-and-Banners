...
from sword_runtime.campaign_command_cycle import _load_operation, _read_cycle, _register_host, retain_campaign_command_decisions
...
def sync_campaign_decision_delivery_routes(planner: Any) -> dict[str, Any]:
    ...
    if cycle_changed:
        cycle["campaign_command_decisions"] = retain_campaign_command_decisions(_decision_rows(cycle))
