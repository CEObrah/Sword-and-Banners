...
_FIELD_TERMS = (
    "kai", "great bow", "bow guard", "champion", "armor", "armour", "horse armor",
...
def settle_house_field_preparation(planner: Any, host: Mapping[str, Any], at: str) -> dict[str, Any] | None:
    ...
    personal_force = planner.read(_PERSONAL_FORCE_PATH)
    champions = planner.read(_CHAMPIONS_PATH)
    gbg_count = role_count(personal_force, "great_bow_guard")
    ...
    prep.update({
        ...
        "great_bow_guard_force_ref": "force_tang_wei_personal",
        "great_bow_guard_personnel": gbg_count,
        ...
        "shortfall_review": [
            "Great Bow Guard full body set and Great War Bow reserves can be compared against accepted manpower exactly.",
