...
class DowntimeAdvanceMixin:
    ...
    def _settle_player_training(self, start: CampaignTime, end: CampaignTime, request_id: str) -> dict[str, Any]:
        ...
        history.append({
            "started_at": str(start), "completed_at": str(end), "mode": "standing_downtime",
            "hours": settled, "requested_hours": whole, "request_id": request_id,
            "program_ref": program_ref, "gain_authority": "registered_deterministic_program",
