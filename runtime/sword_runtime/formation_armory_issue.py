...
_ARMORY_COUNTERS: dict[str, tuple[str, str, str]] = {
    ...
    "weapon_spear_long": ("other_issued_weapons", "Long Spear unissued reserve", "Long Spear issued"),
    "weapon_lance_cavalry": ("other_issued_weapons", "Cavalry Lance unissued reserve", "Cavalry Lance issued"),
    "weapon_sword_one_hand_long": ("other_issued_weapons", "One-Handed Long Sword unissued reserve", "Long One-Handed Sword issued"),
