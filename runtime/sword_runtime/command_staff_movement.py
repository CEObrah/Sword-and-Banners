...
from sword_runtime.operation_routing import current_operational_order, exact_operation_record, iter_exact_operation_records
        ...
        *,
        ...
        for formation_ref in refs:
            try:
                ...
                continue
            current = authoritative_group_ref_for_formation(
                index,
