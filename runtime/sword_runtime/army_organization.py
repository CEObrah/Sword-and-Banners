...
from sword_runtime.command_units import FORMATION, NESTED_ARMY, append_unit, remove_unit, unit_entries, authoritative_group_ref_for_formation
        ...
        *,
        ...
        for formation_ref, raw_loss in sorted(casualty_counts.items()):
            ...
            group_ref = authoritative_group_ref_for_formation(
                index,
                lambda ref: self.read(_group_path(ref)),
                formation_ref,
                formation,
            )
