...
def test_operation_army_movement_may_bring_lawful_house_auxiliaries_without_transferring_ownership(campaign):
    ...
    # assembled with Wei at Kanyou after the completed staging move. The Qin
    # operational order legally compels the 5,000 state-owned Qin bodies, while
    # Wei may march the 4,500 House Tang auxiliaries without transferring anyone's
    # institutional ownership.
    staging_location = _read(campaign, 'state/player.json')['location']
    assert staging_location == 'loc_kanyou'
