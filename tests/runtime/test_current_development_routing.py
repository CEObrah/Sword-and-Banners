...
def test_bastion_current_setting_baseline_and_monthly_training_owner(campaign):
    ...
    before = before_force["cohort_ledger"]["cohorts"]["cohort_force_bastion_iron_wall_bastion_heavy_infantry"]
    assert "training_tracking_baseline" not in before
    ...
    after = after_force["cohort_ledger"]["cohorts"]["cohort_force_bastion_iron_wall_bastion_heavy_infantry"]
...
def test_nested_manor_training_locations_inherit_only_containing_site_capacity(campaign):
    ...
    for location_ref in ("loc_tang_manor_defense_camp", "loc_tang_manor_garrison_yard"):
        ...
        assert env["source"] == "permanent_physical_training_support"
        assert env["source_site_ref"] == "loc_sword_manor"
