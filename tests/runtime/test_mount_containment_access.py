...
def _place_wei_with_mount(campaign, mount_location: str) -> None:
    ...
    prepared = {
        "horse_tang_heavy_war": f"equipped: assigned/prepared at {mount_location}",
        "tack_tang": f"equipped: fitted/prepared on assigned mount at {mount_location}",
        "horse_armor_tang": f"equipped: fitted/prepared on assigned mount at {mount_location}",
    }
