...
class _MemoryPlanner:
    def __init__(self) -> None:
        self.docs = {
            ...
            "state/depots/house-tang.json": {"location_ref": "loc_tang_manor_garrison_yard", "stocks": {"grain_kg": 100000, "fodder_kg": 100000, "war_arrows": 100000}},
...
def test_material_field_reserve_is_transferred_from_depot_to_formation() -> None:
    ...
    result = _issue_material_reserve(planner, formation_ref="formation_test", reserve_days=7, arrow_loads_total=2, at="244-BCE-07-23T10:22:48+08:00")
    assert result["issued"] == {"food_kg": 2800, "fodder_kg": 14000, "war_arrows": 18000}
    ...
    assert depot == {"grain_kg": 97200, "fodder_kg": 86000, "war_arrows": 82000}
