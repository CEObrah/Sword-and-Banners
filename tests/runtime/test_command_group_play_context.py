...
def test_tang_wei_field_army_projects_lin_as_deputy_and_first_successor(campaign: Path) -> None:
    ...
    assert group["deputy_ref"] == "char_lin_zhen"
...
def test_command_group_projection_keeps_lin_visible_and_surfaces_desync(campaign: Path) -> None:
    ...
    lin.setdefault("command_assignment", {})["command_group_ref"] = "cmdgrp.somewhere_else"
