...
from sword_runtime.campaign_command_delivery import CampaignCommandDeliveryMixin
...
def test_time_integration_precedes_domain_settlement_mixins_in_hosted_mro():
    ...
    # Delivery may wrap due-host settlement ahead of chronology in the MRO, but
    # it must never introduce a second top-level runtime-advance authority.
    assert "_advance_runtime" not in CampaignCommandDeliveryMixin.__dict__
