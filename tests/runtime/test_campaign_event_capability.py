...
def test_play_context_advertises_nonblocking_campaign_event_notices(campaign: Path) -> None:
    ...
    assert context["limits"]["campaign_event_notices_nonblocking"] is True
