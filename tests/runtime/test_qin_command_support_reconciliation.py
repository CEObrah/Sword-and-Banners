...
def test_reconciliation_never_promotes_pending_order_by_chronology(monkeypatch):
    ...
    # Pending-work discovery is independent of current-order authority, so the
    # still-unbriefed directive remains routable without being made current.
