...
def _unit_formation(*, strength: int, active_1000: int, active_500: int, active_100: int, top_commander: bool = True) -> dict:
    return {
        "personnel": strength,
        "authorized_strength": strength,
        "formation_class": "unit",
        "commander_ref": "char_unit_commander" if top_commander else None,
        "officer_cadre": {
            "rank_inventory": {
...
def test_mass_capacity_shortfall_reduces_verified_edu() -> None:
    ...
    settle_cohort_program(
        ...
        role_exposure_hours=0, training_rules=rules, facility_grade="home_garrison",
...
def test_aggregate_command_posts_count_as_staffed_hierarchy() -> None:
    ...
    formation["attached_unit_command_by_role"] = {"command_personnel": 1}
    ...
    runtime = MemoryRuntime(
        {
            ...
            "char_army_staff": _exact("char_army_staff", sword=160, leadership=150),
        },
        {"cmdgrp.field": {"commander_ref": "char_army", "direct_person_refs": ["char_army_staff"], "role_assignments": {"char_army_staff": "training_officer"}}},
    )
    formation = _unit_formation(strength=2000, active_1000=2, active_500=4, active_100=20)
...
def test_instructor_can_still_train_personally_with_remaining_time() -> None:
    ...
    result = settle_exact_program(
        ...
        facility_grade="home_garrison", equipment_grade="adequate", recovery_grade="adequate",
