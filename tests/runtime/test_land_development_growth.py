...
def test_tang_manor_6000_500_50_nested_land_capacity_and_commute_are_physical(campaign):
    ...
    sword = land['sites']['loc_sword_manor']
    ...
    assert nested_site_children(land, 'loc_tang_manor') == ['loc_sword_manor']
    assert nested_site_children(land, 'loc_tang_manor', recursive=True) == ['loc_sword_manor', 'loc_tang_inner_citadel']
    assert enclosure_chain(land, 'loc_tang_inner_citadel') == ['loc_tang_manor', 'loc_sword_manor', 'loc_tang_inner_citadel']
    ...
    sword_support = infra['sites']['loc_sword_manor']
    ...
    assert pop['population_total'] == 725_000
    assert sum(pop['strata'].values()) == 725_000
    ...
    constrained['sites']['loc_sword_manor']['fortification']['gate_count'] = 6
