...
def test_nested_tang_fortifications_are_exact_and_route_to_their_own_perimeters(campaign):
    ...
    assert sword['plan_length_m']*sword['plan_width_m']/1_000_000 == sword['area_km2']
    assert 2*(sword['plan_length_m']+sword['plan_width_m'])/1000 == sword['constructed_wall_centerline_perimeter_km']
    assert sword['tower_station_interval_m']*sword['tower_count']/1000 == sword['constructed_wall_centerline_perimeter_km']
