...
def test_stats_above_200_continue_to_improve_personal_and_formation_combat(campaign):
    ...
    person_200={'attributes':{'Agility':200,'Coordination':200,'Awareness':200,'Endurance':200},'skills':{'Sword':200,'Mass Combat':200,'Athletics':200}}
    person_300={'attributes':{'Agility':300,'Coordination':300,'Awareness':300,'Endurance':300},'skills':{'Sword':300,'Mass Combat':300,'Athletics':300}}
    ...
    assert cohort['attribute_max']['Agility'] > 200
    assert cohort['skill_max']['Sword'] > 200
    assert cohort['aptitude_max']['physical_learning'] > 200
...
def test_personal_combat_uses_independent_action_ready_timestamps(campaign):
    ...
    player.setdefault('skills',{}).update({
        'Sword':300,'Defense':280,'Athletics':280,'Mass Combat':260,
    })
    ...
    other.setdefault('skills',{}).update({
        'Sword':25,'Spear':25,'Defense':20,'Athletics':20,'Mass Combat':10,
    })
