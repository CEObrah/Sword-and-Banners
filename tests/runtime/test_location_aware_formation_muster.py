    ...
    def __init__(self) -> None:
        ...
        self.docs = {
            self.force_path: {
                ...
                "available_by_role": {"great_bow_guard": 300},
                "available_by_location": {
                    "loc_training": {"great_bow_guard": 300},
                    "loc_default": {"great_bow_guard": 0},
                },
            }
        }
...
def test_exact_location_pool_can_muster_without_changing_default_source() -> None:
    ...
    assert force["available_by_role"]["great_bow_guard"] == 0
    assert force["available_by_location"]["loc_training"]["great_bow_guard"] == 0
