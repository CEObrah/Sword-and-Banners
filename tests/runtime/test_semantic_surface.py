...
def test_remaining_semantic_command_surface(campaign):
    ...
    execute_internal(campaign,'command_transfer',{'formation_ref':'formation_surface','commander_ref':'char_surface_officer','command_authority':'char_surface_officer'})
    execute_internal(campaign,'formation_assign',{'formation_ref':'formation_surface','commander_ref':'char_heki','command_authority':'state_qin'})
