...
def test_every_eligible_npc_sector_advances_in_same_review_window(campaign):
    ...
    # This regression is about scheduler fairness across sectors, not command
    # vacancy. Use three currently command-eligible Wei formations so a mutable
    # campaign vacancy cannot turn the setup into an impossible battle fixture.
    wei_refs = [
        'formation_wei_reserve_infantry_01',
        'formation_wei_chariot_screen',
