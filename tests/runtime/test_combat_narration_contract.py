...
COMBAT = ROOT / "plugins/sword-and-banners/skills/sword-and-banners-game-master/references/combat-and-warfare.md"
...
def test_multi_attacker_narration_exposes_shared_defensive_commitment_not_fresh_duels():
    ...
    for term in ("weight", "blade", "shield", "grapple", "fall", "obstacle"):
        assert term in text
