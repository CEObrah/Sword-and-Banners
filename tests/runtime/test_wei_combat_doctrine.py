...
def test_wei_saved_doctrine_prefers_function_denial_softspots(campaign):
    ...
    doctrine = wei['behavior']['combat_targeting_doctrine']
    ...
    assert aim['selection_basis'] == 'saved_combat_targeting_doctrine'
...
def test_wei_lethal_doctrine_prefers_fast_vital_line_without_overriding_player_lethality(campaign):
    ...
    assert 'player decision' in wei['behavior']['combat_targeting_doctrine']['protected_lethality_rule']
