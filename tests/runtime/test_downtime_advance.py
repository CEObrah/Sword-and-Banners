...
class _BoundaryBase:
    ...
    def _prepare_scheduler_for_advance(self, _target_text: str):
        return None
...
class _BoundaryPlanner(ProductionTimeIntegrationMixin, DowntimeAdvanceMixin, _BoundaryBase):
    _interruptible_personal_travel = False
    _active_command_type = ""

    # Exercise the real centralized event-bounded chronology while keeping this
    # fixture intentionally tiny. Route synchronization and post-domain hooks
    # are outside the boundary behavior under test.
