...
class _FakeFortress(FortifiedSiteRuntimeMixin):
    ...
    def _siege_emplacement_crew_rows(self, refs):
        # Feed the current fixed-emplacement service abstraction directly.
        # The production path no longer reads a handheld-crossbow personnel score.
        return [{"count": 120, "score": self.crew_control}]
