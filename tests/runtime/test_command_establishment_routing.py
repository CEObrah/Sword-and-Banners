...
def test_named_unit_command_satisfies_two_external_command_billets_per_qin_unit(campaign):
    ...
    missing["command_structure"]["unit_command"]["deputy_ref"] = None
...
def test_champions_command_pair_is_external_to_five_hundred_fighting_strength(campaign):
    ...
    assert formation["command_structure"]["internal_hierarchy"] == [
        {"count": 5, "representation": "aggregate", "scale": 100}
    ]
...
def test_house_tang_owner_matches_current_campaign_authority(campaign):
    ...
    assert house["administrative_programs"]["house_equipment_production"]["last_close"] == "244-BCE-07-29T06:00:00+08:00"
