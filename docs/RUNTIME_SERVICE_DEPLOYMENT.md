...
Deploy `CEObrah/Sword-and-Banners` from `main` after the Gold release gate is green. Attach a persistent volume at `/data` for the campaign Git checkout plus private WAL/receipt/recovery data.
